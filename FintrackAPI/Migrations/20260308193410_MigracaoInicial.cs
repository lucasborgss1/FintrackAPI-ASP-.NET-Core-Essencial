    ...
    public partial class MigracaoInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoTransacoes", x => x.TipoTransacaoId);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoriaId = table.Column<int>(type: "int", nullable: false),
                    TipoTransacaoId = table.Column<int>(type: "int", nullable: false),
                    IsCredito = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsRecorrente = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
